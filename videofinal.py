...
file_size = (500,500) # Assumes 1920x1080 mp4
filename = 'C:\Python311\km_20230603_1080p_30f_20230603_131743.mp4'
scale_ratio = 1 # Option to scale to fraction of original size. 
print(file_size)

# We want to save the output to a video file
output_filename = 'C:\Python311\km_20230603_1080p_30f_20230603_131743.mp4'
output_frames_per_second = 20.0
print(output_frames_per_second)
